...
const propTypes = {
  ...
  /**
   * Function callback for when the appropriate click or key action is performed. Callback contains the javascript event and prop metadata, e.g. onSelect(event, metaData)
   */
...
const Item = ({
  ...
  */
  <li tabIndex="-1" role="presentation">
    <div
      {...customProps}
      onClick={(event) => { requestClose(event); onSelect(event, metaData); }}
      role="menuitem"
      tabIndex="0"
      className={cx([
        'item',
